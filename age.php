...
// Program to display complete URL
  ...
  $link .= $_SERVER['PHP_SELF'];
       ...
       $url= "http://localhost/onlineShopping/age.php?age=".$_GET['age']."";
        ...
        $queryCheck = mysqli_query($conn, "SELECT age_range FROM kidit_age WHERE age_id=".$_SESSION['age']."");
        $getAgeRange = mysqli_fetch_assoc($queryCheck);
?>

    <header>
      <div >
        <span class=text style="color: red;padding: 14px 0px 14px 25px;"><a href="index.php" style="color:red;">Home</a> / <a href="shop.php" style="color:red;">Shop</a> / <a href="age.php?age=<?php echo $_GET['age']; ?>" style="color:red">Age - <?php echo $getAgeRange['age_range']; ?></a></span>
         <p class="message"></p>
      ...
      <div class="dropDown-wrapper">
        ...
        if ($_SESSION['age'])
        {
            $ageSelected = "age_id = ".$_SESSION['age']." AND";
            $sort = " ";
        }

        if($_SESSION['sort'] && $_SESSION['age'])
        {
            if($_SESSION['sort'] == 1)
            {
              $sort = "ORDER BY product_name ASC";
   ...
   <div class="container">
    <div class="row">
                <?php
                    $qryProduct = mysqli_query($conn, "SELECT * FROM kidit_product WHERE $ageSelected product_status = 1 $sort");

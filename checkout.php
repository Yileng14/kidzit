  ...
  <div class="row">
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <form class="card p-2">
        ...
        <div class="row">
          <div class="col">
            <div class="panel panel-1">Delivery Fee:</div>
          </div>
          <div class="col">
            <div class="panel panel-3">-RM xxx.xx</div>
          </div>
        ...
        <br>
          <div class="row">
          <div class="col">
            <div class="panel panel-1">Total:</div>
          </div>
          <div class="col">
            <div class="panel panel-3"  style="font-weight:bold;">RM xxx.xx</div>
          </div>
        </div> 
      </form>
    </div>
        ...
        <div class="row">
         ...
         <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="phoneNo" placeholder="" value="" required>
            <div class="invalid-feedback">

...
<?php
        ...
        if($url == "http://localhost/onlineShopping/shop.php")
        {
            $_GET['sort'] = "ALL";
        }
    ...
    <header>
      ...
      <div class="dropDown-wrapper">
        ...
        echo '<div style = "margin-top:3px;">
                <select class="btn btn-lg pull-right header-btn " style="margin-top:3px;max-width:320px;margin-right:10px;height:37px; padding:6px 6px;" onchange="window.location=\'shop.php?sort=\'+this.value">

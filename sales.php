...
<?php
        ...
        if($url == "http://localhost/onlineShopping/sales.php")
        {
            $_GET['sort'] = "ALL";
        }
...
?>
    ...
    <header>
      <div >
        <span class=text style="color: red;padding: 14px 0px 14px 25px;"><a href="index.php" style="color:red;">Home</a> / <a href="shop.php" style="color:red;">Shop</a> </span>
         <p class="message"></p>
      ...
      <div class="dropDown-wrapper">
        ...
        echo '<div style = "margin-top:3px;">
                <select class="btn btn-lg pull-right header-btn " style="margin-top:3px;max-width:320px;margin-right:10px;height:37px; padding:6px 6px;" onchange="window.location=\'sales.php?sort=\'+this.value">
...
<div class="container">
    <div class="row">
        <?php
            $qryProduct = mysqli_query($conn, "SELECT * FROM kidit_product WHERE product_status = 1 $sort");
